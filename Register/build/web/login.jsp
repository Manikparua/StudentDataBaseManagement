                ...
                <div class="col m6 offset-m3">
                    <div class="card"style="margin-top:50px;">
                        <div class="card-content">
                            <h3 class="center-align" style="margin-top: 10px;">Login Here</h3>
                            <div class="form center-align">
                                <form action="/Register/Login_Serv" method="post">
                                    <input type="email" placeholder="Enter email" name="user_email">
                                    <input type="password" placeholder="Enter password" name="user_pass">
                                    <button class="btn waves-effect waves-light #ff6d00 orange accent-4" type="submit" name="action">Login
                                    </button>
                                </form>                       
                            </div>
                        </div>
